...
void wifi_init_sta(void)
{
    ...
    ESP_LOGI(TAG, "DEST ap SSID:%s password:%s", wifi_config->sta.ssid, wifi_config->sta.password);
    ESP_LOGI(TAG, "DEST ap SSID:%d password:%d", sizeof(wifi_config->sta.ssid), sizeof(wifi_config->sta.password));
    ESP_LOGI(TAG, "SRC ap SSID:%d password:%d", sizeof(ssid), sizeof(pass));
